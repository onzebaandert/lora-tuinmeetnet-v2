...
|---|---|---|---|---|
| SOIL1 | XIAO ESP32-C3 + CWT Modbus | `CLAUDE_LORA_VV_SOIL1_V1` | 10 min | :08 |
| SOIL2 | XIAO ESP32-C3 + ZTS Modbus | `CLAUDE_LORA_VV_SOIL2_V1` | 10 min | :16 |
| BH1750 | XIAO ESP32-C3 + BH1750 + DS3231 | `CLAUDE_LORA_VV_BH1750_V1` | 10 min | :08 |
...
## Timing (10-minuten cyclus, DS3231 RTC)

Alle nodes waken op een vast tweede binnen het 10-minuten interval. De volgorde zorgt dat data beschikbaar is vóór de volgende schakel stuurt.

...
lines.push('systeem agg_seq=' + (d.a||0) + 'i,rssi_lora=' + (d.r||0) + ',vbat_agg=' + (d.av||0) + 'i,temp_agg=' + (d.ac||0) + ',vbat_mesh=' + (d.mv||0) + 'i,temp_mesh=' + (d.mc||0) + ',rssi_heltec=' + (d.lr||0) + ',snr_heltec=' + (d.ls||0) + ',lnHel_vbat=' + (d['lnHelTuin-vbat']||0) + 'i,lnC3_vbat=' + (d['lnC3-vbat']||0) + 'i,lnHelMqtt_vbat=' + (d['lnHelMqtt-vbat']||0) + 'i,hel_temp=' + (d.hel_temp||0) + ' ' + ts);
